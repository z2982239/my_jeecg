		...
		<fieldset>
			<table>
				<tr>
					...
					<td><script src="plug-in/jquery/jquery.regionselect.js"
							type="text/javascript"></script> <input type="text" id="province"
						style="width: 32%;" value="" /> <input type="text" id="city"
						style="width: 32%;" value="" /> <input type="text" id="area"
						style="width: 32%;" value="" /></td>
				</tr>
			</table>
		</fieldset>
