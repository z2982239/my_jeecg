...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="jeecgMysearchList" checkbox="true"
			pagination="false" fitColumns="false" title="自定义列表查询条件"
			...
			<t:dgCol title="生日" field="birthday" formatter="yyyy-MM-dd"
				queryMode="group" width="200"></t:dgCol>
			<t:dgCol title="部门" field="depId"
		...
		<div id="jeecgMysearchListtb" style="padding: 3px; height: 25px">
			<div style="float: left;">
				<a href="#" id="add" class="easyui-linkbutton" plain="true"
					icon="icon-add"
					onclick="add('录入','jeecgListDemoController.do?goAdd','jeecgMysearchList')">用户录入</a>
				<a href="#" class="easyui-linkbutton" plain="true" icon="icon-edit"
					onclick="update('编辑','jeecgListDemoController.do?goUpdate','jeecgMysearchList')">用户编辑</a>
			</div>
			<div align="right">
				名称：<input class="inuptxt ac_input" type="text" name="name">
				年龄：<input class="easyui-validatebox" type="text" name="age">
				<a href="#" class="easyui-linkbutton" iconCls="icon-search"
					onclick="jeecgMysearchListsearch();">查询</a> <a href="#"
					class="easyui-linkbutton" iconCls="icon-reload"
					onclick="searchReset('jeecgMysearchList')">重置</a>
			</div>
		</div>
	</div>
</div>
