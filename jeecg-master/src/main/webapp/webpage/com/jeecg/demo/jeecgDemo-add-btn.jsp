		...
		<table style="width: 500px;" cellpadding="0" cellspacing="1"
			...
			<tr>
				...
				<td class="value"><input id="age" name="age" type="text"
					style="width: 150px" class="inputxt" datatype="d" /> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><t:webUploader name="touxiang" auto="true"
			...
			<tr>
				...
				<td class="value"><t:webUploader auto="true" name="fujian"></t:webUploader>
				</td>
			</tr>
