...
<script type="text/javascript"
	src="<%=basePath%>/plug-in/jquery/jquery.jqprint.js"></script>
...
<body style="overflow-y: hidden" scroll="no">
		...
		<t:formvalid formid="formobj" dialog="true" usePlugin="password"
			...
			<table style="width: 600px;" cellpadding="0" cellspacing="1"
				...
				<tr>
					...
					<td class="value"><fmt:formatDate value='${jgDemo.birthday }'
				...
				<tr>
					<td align="right"><label class="Validform_label"> 电话:
					</label></td>
				...
				<tr>
					<td align="right"><label class="Validform_label"> 部门:
					</label></td>
					<td class="value"><c:forEach items="${departList}"
							var="depart">
				...
				<tr>
					<td align="right"><label class="Validform_label">
							创建日期: </label></td>
					<td class="value"><fmt:formatDate value='${jgDemo.createDate}'
							type="date" pattern="yyyy-MM-dd HH:m:ss" /></td>
				</tr>
	...
	<a class="easyui-linkbutton" style="margin-top: 3px" icon="icon-print"
		href="javascript:printall()">打印</a>
</body>