...
<div style="height: 100%; margin: 14px 20px 0 20px; overflow-y: auto">
	...
	<div style="margin-right: 50px;">
		<ul>
			<li>生成代码包的路径(jeecg_config.properties)： <pre class="code">
  ...
  <span class="propTag">bussi_package</span>=<span class="propValue">com.buss</span> // 生成代码的包前缀
			...
			<li>代码生成界面的配置：
				<ol>
					<li>表名：<span class="propValue">guoming_test</span>；
					</li>
					<li>包名：<span class="propValue">guoming</span>；
					</li>
					<li>代码分层风格：<span class="propValue">代码分层</span>；
					</li>
				</ol>
			</li>
		</ul>
