...
<!--[if lt IE 7]>
    ...
    <![endif]-->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/plug-in/teemlink/css/login.css"
	type="text/css" />
</head>
<body>

	<form action="loginController.do?login"
		...
		<div align="center" class="container loginBg">
			...
			<div class="login">
				...
				<ul class="loginInfo">
					<li><span>用户名：</span> <input type="text" class="userName"
						value="admin" name="userName" id="userName" /></li>
					<li><span>密 &nbsp;码：</span> <input type="password"
						name="password" class="password" value="123456" name="password"
						id="password" /></li>
					<li><span>验证码：</span>

						<div style="width: 50px; float: left">
							<input name="randCode" style="width: 90px; height: 26px;"
								type="text" id="randCode" title="" value="" nullmsg="" />
					...
					<li class="keepInfo"><input type="checkbox" id="on_off"
						name="remember" value="yes" />记住用户名</li>
					<li class="tipsArea"><div id="tipsArea">&nbsp;</div></li>
					<li class="btnOk"><input type="button" id="but_login"
						value="<t:mutiLang langKey="common.login"/>"
						class="loginBtn loginBg" /></li>
				</ul>
			</div>

			<div class="copyright ">
				<span>&copy; JEECG 版权所有 <span class="tip"><a href="#"
						title=JEECG 演示系统>jeecg</a> (推荐使用IE8+,谷歌浏览器) 技术支持：:<a href="#"
						title=JEECG 演示系统>jeecg</a></span></span>
			</div>
		</div>
	</form>
