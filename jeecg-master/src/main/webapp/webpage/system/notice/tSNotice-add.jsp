...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="noticeController.do?doAdd" tiptype="1"
		...
		<table style="width: 100%" cellpadding="0" cellspacing="1"
			...
			<tr>
				...
				<td class="value"><input id="noticeTitle" name="noticeTitle"
					type="text" style="width: 95%" class="inputxt"> <span
			...
			<tr>
				...
				<td class="value"><input id="noticeContent"
					name="noticeContent" type="hidden"> <script id="content"
						type="text/plain" style="width: 700px;"></script> <script
			...
			<tr>
				<td align="right"><label class="Validform_label"> 类型: </label>
				</td>
				<td class="value"><input type="radio" name="noticeType"
					value="1" datatype="*" />通知 &nbsp;&nbsp;<input type="radio"
					name="noticeType" value="2" checked="checked" />公告 <span
					class="Validform_checktip"></span> <label class="Validform_label"
					style="display: none;">通知公告类型</label></td>
			</tr>
			<tr>
				...
				<input type="radio" name="noticeLevel" value="3"
					...
					id="userName_span" style="display: none"> <input
						...
						readonly="readonly" /> <t:choose hiddenName="userid"
							...
							textname="userName" isclear="true" isInit="true"></t:choose> <span
						class="Validform_checktip"></span> <label class="Validform_label"
						style="display: none;">授权级别</label></td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label"
					style="white-space: nowrap;"> 阅读期限: </label></td>
				<td class="value"><input id="noticeTerm" name="noticeTerm"
