...
<t:datagrid name="departUserList" title="common.operation"
	...
	<t:dgDelOpt title="common.delete"
		url="departController.do?delUserOrg&userid={id}&departid=${departid }"
		urlclass="ace_button" urlfont="fa-trash-o" />
	<t:dgToolBar title="common.add.param" langArg="common.user"
		icon="icon-add"
		url="userController.do?addorupdate&departid=${departid}" funname="add"></t:dgToolBar>
	...
	<t:dgToolBar title="common.add.exist.user" icon="icon-add"
		...
		funname="add" width="500"></t:dgToolBar>
</t:datagrid>
