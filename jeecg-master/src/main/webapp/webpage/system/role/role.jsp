		...
		<fieldset class="step">
			<div class="form">
				<label class="Validform_label"><t:mutiLang
						langKey="common.role.name" />:</label> <input name="roleName"
					class="inputxt" value="${role.roleName }" datatype="s2-8">
				<span class="Validform_checktip"><t:mutiLang
						langKey="rolescope.rang2to8.notnull" /></span>
			</div>
			<div class="form">
				<label class="Validform_label"> <t:mutiLang
					...
					class="inputxt" value="${role.roleCode }" datatype="s2-15">
				<span class="Validform_checktip"><t:mutiLang
						langKey="rolecode.rang2to15.notnull" /></span>
			</div>
		</fieldset>
	</t:formvalid>
</body>
