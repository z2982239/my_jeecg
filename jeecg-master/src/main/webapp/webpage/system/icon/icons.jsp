	...
	<t:formvalid formid="formobj" layout="div" dialog="true"
		...
		<fieldset class="step">
			<div class="form">
				...
				</label> <input name="iconName" datatype="s2-10" id="iconName"
					value="${icon.iconName}" class="inputxt"> <span
					class="Validform_checktip"><t:mutiLang
						langKey="iconname.rang2to10" /></span>
			</div>
			<div class="form">
				<label class="Validform_label"> <t:mutiLang
						langKey="common.icon.type" />:
				</label> <select name="iconType" id="iconType">
					<option value="1"
						<c:if test="${icon.iconType=='1'}">selected="selected"</c:if>><t:mutiLang langKey="system.icon"/></option>
