...
<link rel="stylesheet" type="text/css"
	href="plug-in/lhgDialog/skins/default.css">
...
<body>
	<div>
		<input id='menuLink' type='text' style="width: 380px;"
			disabled="disabled" />
	</div>
	<div class="ui_buttons" style="padding-left: 240px;">
		<input type="button" id="copyBtn" value="复制"
			class="ui_state_highlight"> <input type="button"
			id="closeBtn" value="关闭" onclick='close();'>
	</div>
</body>
</html>