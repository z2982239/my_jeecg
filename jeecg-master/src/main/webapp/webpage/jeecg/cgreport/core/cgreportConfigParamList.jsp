...
<div
	...
	<table border="0" cellpadding="2" cellspacing="0"
		...
		<tbody id="add_cgreportConfigParam_table">
			...
			<c:if test="${fn:length(cgreportConfigParamList)  > 0 }">
				<c:forEach items="${cgreportConfigParamList}" var="poVal"
					varStatus="stuts">
					<tr>
						<td align="center"><input style="width: 20px;"
							type="checkbox" name="ck" /></td>
						<input name="cgreportConfigParamList[${stuts.index }].id"
							type="hidden" value="${poVal.id }" />
						<input name="cgreportConfigParamList[${stuts.index }].cgrheadId"
							type="hidden" value="${poVal.cgrheadId }" />
						<td align="left"><input
							name="cgreportConfigParamList[${stuts.index }].paramName"
							value="${poVal.paramName }" maxlength="32" type="text"
							class="inputxt" style="width: 120px;"></td>
						<td align="left"><input
							name="cgreportConfigParamList[${stuts.index }].paramDesc"
							value="${poVal.paramDesc }" maxlength="32" type="text"
							class="inputxt" style="width: 120px;"></td>
						<td align="left"><input
							name="cgreportConfigParamList[${stuts.index }].paramValue"
							value="${poVal.paramValue }" maxlength="32" type="text"
							class="inputxt" style="width: 120px;"></td>
						<td align="left"><input
							name="cgreportConfigParamList[${stuts.index }].seq"
