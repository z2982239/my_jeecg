				...
				<ul class="nav ace-nav">
					...
					<li class="purple"><a data-toggle="dropdown"
						...
						<ul
							...
							<li class="dropdown-header" id="noticeTip"><i
								class="ace-icon fa fa-exclamation-triangle"></i> 0 Notifications
								<!-- ajax加载 --></li>
							...
							<li class="dropdown-footer"><a
								href="javascript:goAllNotice();" id="noticeFooter"> See all
									notifications <i class="ace-icon fa fa-arrow-right"></i> <!-- ajax加载 -->
							</a></li>
						</ul></li>
					...
					<li class="green"><a data-toggle="dropdown"
						...
						<ul
							...
							<li class="dropdown-header" id="messageTip"><i
								class="ace-icon fa fa-envelope-o"></i> 0 Messages <!-- ajax加载 -->
							</li>
							...
							<li class="dropdown-footer"><a
								href="javascript:goAllMessage();" id="messageFooter"> See
									all messages <i class="ace-icon fa fa-arrow-right"></i> <!-- ajax加载 -->
							</a></li>
						</ul></li>
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							src="plug-in/ace/avatars/avatar2.png" alt="Jason's Photo" /> <span
							class="user-info"> <small>${userName }</small> <span
								style="color: #666633">${roleName }</span>
...
<![endif]-->
	...
	<div class="theme-popover">
		...
		<div class="theme-popbod">
			...
			<p id="msgContent"
				style='overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 5; -webkit-box-orient: vertical;'></p>
		</div>
		<div style="text-align: center;">
			<a href="javascript:readMessage();"
				class="btn2 btn-primary btn-large" style="color: #0088DB;">已读</a> <a
				href="#" class="btn2 btn-primary btn-large gray" id="closeBtn"
				style="color: #0088DB;">关闭</a>
		</div>
	</div>
